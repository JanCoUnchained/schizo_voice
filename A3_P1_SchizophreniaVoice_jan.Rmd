...
library(pacman)
p_load(tidyverse, pastecs, lmerTest, corrplot)
...
p_load(lme4)
model1 <- lmer(mean ~ diagnosis + (1|ID) + (1|triangle) + (1|study), data = pdf)
summary(model1) #bigger mean - significant

model2 <- lmer(sd ~ diagnosis + (1|ID) + (1|triangle) + (1|study), data = pdf)
summary(model2) #not significant

model3 <- lmer(iqr ~ diagnosis + (1|ID) + (1|triangle) + (1|study), data = pdf) 
summary(model3) #smaller iqr

model4 <- lmer(range ~ diagnosis + (1|ID) + (1|triangle) + (1|study), data = pdf) 
summary(model4) #significant

model5 <- lmer(median ~ diagnosis + (1|ID) + (1|triangle) + (1|study), data = pdf) 
summary(model5) #very significant 

model6 <- lmer(mean_abs ~ diagnosis + (1|ID) + (1|triangle) + (1|study), data = pdf)
